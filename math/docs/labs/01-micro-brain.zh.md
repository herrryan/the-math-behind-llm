...
## 第 1 步：3 岁小孩也能懂的直觉比喻（发条打孔音乐盒） {: #step-1 }
...
## 第 2 步：数学公式到纯 Python 代码的映射桥梁 {: #step-2 }
...
## 第 3 步：完整源码与数学解剖 {: #step-3 }

为了让大家通过“亲手手搓”获得最扎实的物理与数学肌肉记忆，本工坊提供两个配套代码文件：
- **启发式填空练习模板**：[`../labs/01_../labs/01_micro_brain_exercise.py`](file:///Users/guofei/workspace/the-math-behind-llm/../labs/01_../labs/01_micro_brain_exercise.py)（亦位于 [`04b-lab-micro-brain/../labs/01_micro_brain_exercise.py`](file:///Users/guofei/workspace/the-math-behind-llm/04b-lab-micro-brain/../labs/01_micro_brain_exercise.py)），将核心数学变换留空为带有启发式注释、张量形状与断言校验的 TODO 桩函数；
- **完整参考答案代码**：[`../labs/01_../labs/01_micro_brain.py`](file:///Users/guofei/workspace/the-math-behind-llm/../labs/01_../labs/01_micro_brain.py)（亦位于 [`04b-lab-micro-brain/../labs/01_micro_brain.py`](file:///Users/guofei/workspace/the-math-behind-llm/04b-lab-micro-brain/../labs/01_micro_brain.py)）。
...
## 第 4 步：历史渊源与技术演进（Bengio 2003 的破晓时刻） {: #step-4 }
