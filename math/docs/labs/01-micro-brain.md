...
## Step 1: 3-Year-Old Intuition (The Clockwork Punched Music Box) {: #step-1 }
...
## Step 2: The Math Bridge to Pure Python {: #step-2 }
...
## Step 3: Complete Source Code & Math Anatomy {: #step-3 }

To maximize your learning through active recall, we provide two versions of this lab:
- **Guided Exercise Template**: [`../labs/01_../labs/01_micro_brain_exercise.py`](file:///Users/guofei/workspace/the-math-behind-llm/../labs/01_../labs/01_micro_brain_exercise.py) (also in [`04b-lab-micro-brain/../labs/01_micro_brain_exercise.py`](file:///Users/guofei/workspace/the-math-behind-llm/04b-lab-micro-brain/../labs/01_micro_brain_exercise.py)), where the core mathematical transformations are left as guided TODO stubs with heuristic hints and automated unit tests.
- **Complete Reference Solution**: [`../labs/01_../labs/01_micro_brain.py`](file:///Users/guofei/workspace/the-math-behind-llm/../labs/01_../labs/01_micro_brain.py) (also in [`04b-lab-micro-brain/../labs/01_micro_brain.py`](file:///Users/guofei/workspace/the-math-behind-llm/04b-lab-micro-brain/../labs/01_micro_brain.py)).
...
## Step 4: Historical Origin (Bengio 2003 & The Dawn of Modern NLP) {: #step-4 }
...
## Step 5: Execution Trace & Autoregressive Generation {: #step-5 }
...
## Step 6: Core Takeaway & The Fatal Bottleneck {: #step-6 }
