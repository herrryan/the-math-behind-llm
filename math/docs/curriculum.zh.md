...
!!! note "3岁小孩的直觉: How to Think About This Entire Guide"
...
<table border="1" cellpadding="8" cellspacing="0" width="100%">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="module-2/04b-lab-micro-brain.zh.md">Lab 01 (Post Module 2)</a></td>
...
- [Chapter 00: The Next-Word Guessing Game](module-0/00-next-word-prediction.zh.md)
...
- [Chapter 01: The Word Map (Vectors & Embeddings)](module-1/01-vectors-and-spaces.zh.md)
...
- [Chapter 02: Measuring Closeness (Dot Product & Cosine Similarity)](module-1/02-dot-product-and-similarity.zh.md)
...
- [Chapter 03: The Magic Stretching Box (Matrix Multiplication)](module-2/03-matrix-multiplication.zh.md)
...
- [Chapter 04: The One-Way Gate (Activation Functions: ReLU, GELU, SwiGLU)](module-2/04-activation-functions.zh.md)
...
- [Hands-on Lab 01: Training Your First Brain in 80 Lines of Pure Python (Bengio 2003)](module-2/04b-lab-micro-brain.zh.md)
...
- [Chapter 05: The Transformer Blueprint (The Bird's-Eye View & The Round Table)](module-3/05-transformer-architecture.zh.md)
...
- [Chapter 06: The Library Clue Hunt (Queries, Keys, and Values)](module-3/06-queries-keys-values.zh.md)
...
- [Chapter 07: The Fair Voting Booth (The Softmax Function)](module-3/07-softmax-function.zh.md)
...
- [Chapter 08: The Attention Formula & Why We Divide by $\sqrt{d_k}$](module-3/08-attention-formula.zh.md)
...
- [Chapter 09: Blindfolds on Future Words (Causal Masking)](module-4/09-causal-masking.zh.md)
...
- [Chapter 10: Where in the Sentence Am I? (Positional Encodings & RoPE)](module-4/10-positional-encodings.zh.md)
...
- [Chapter 11: Looking Through Different Glasses (Multi-Head Attention)](module-4/11-multi-head-attention.zh.md)
...
- [Chapter 12: The Shortcut Bridge (Residual Connections)](module-5/12-residual-connections.zh.md)
...
- [Chapter 13: Keeping Everyone Calm (LayerNorm & RMSNorm)](module-5/13-layer-norm-and-rmsnorm.zh.md)
...
- [Chapter 14: The Thinking Chamber (Feed-Forward Networks)](module-5/14-feed-forward-networks.zh.md)
...
- [Chapter 15: How Wrong Was I? (Cross-Entropy Loss & Perplexity)](module-6/15-cross-entropy-loss.zh.md)
...
- [Chapter 16: Walking Down the Mountain (Gradients & Backpropagation)](module-6/16-gradients-and-backpropagation.zh.md)
...
- [Chapter 17: The Smart Walker (Momentum and the Adam Optimizer)](module-6/17-adam-optimizer.zh.md)
...
- [Chapter 18: Turning Up the Heat (Temperature, Top-k, & Top-p Sampling)](module-7/18-sampling-and-temperature.zh.md)
...
- [Chapter 19: Teaching Good Manners (RLHF, Reward Modeling, and DPO)](module-8/19-rlhf-and-dpo.zh.md)
...
!!! tip "核心要点: Ready to Begin the Journey?"
    Dive straight into [Chapter 00: The Next-Word Guessing Game](module-0/00-next-word-prediction.zh.md) to build your first mathematical foundation!
