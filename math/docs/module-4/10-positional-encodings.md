...
## Step 1: 3-Year-Old Intuition (The Runner Bibs & The Spinning Dials) {: #step-1 }

!!! note "3-Year-Old Intuition: The Scrambled Photo & The Spinning Clock Hands"
...
## Step 5: Concrete Toy Example (Hand Arithmetic on a 2D Slice) {: #step-5 }
...
!!! tip "Key Insight: The Punchline of RoPE"
