...
> 
> Mathematics is simply the blueprint of those knobs and gears. It tells us how the box turns words into numbers, how it remembers who did what, and how it adjusts its knobs so it stops making silly mistakes. 🛠️
...
| :--- | :--- | :--- | :--- |
| **Step 1** | **🧸 3-Year-Old Intuition** | Core physical intuition with zero mathematical jargon | Mystery boxes, playground maps, spotlight beams, Play-Doh presses |
| **Step 2** | **🌉 The Bridging Question** | How to translate the physical game into computer numbers | Moving from intuitive physical concepts to numerical matrices |
| **Step 3** | **📐 The Exact Math & Formula** | The genuine formula used in modern LLMs (Vaswani, LLaMA) | Explicit Greek symbols ($\sum, \prod, \exp, \nabla$), subscripts, and matrix dimensions |
| **Step 4** | **🔍 Where Did It Come From?** | Historical and mathematical origin of the equation | Who invented it, why this functional form, and what failed before |
| **Step 5** | **🔢 Concrete Toy Example** | Step-by-step arithmetic with tiny numbers ($2\text{D}/3\text{D}$ vectors) | Hand-calculated operations verifying every addition and multiplication |
| **Step 6** | **💡 Core Takeaway** | Punchy 1–2 sentence summary of why this formula matters | The mental anchor for the overall LLM brain |
...
### 🗺️ Module 1: Representing Words with Numbers (Vector Geometry)
...
- [🗜️ Chapter 03: The Magic Stretching Box (Matrix Multiplication)](03-matrix-multiplication/index.html)
...
- [🏷️ Chapter 05: The Library Clue Hunt (Queries, Keys, and Values)](05-queries-keys-values/index.html)
...
- [🗳️ Chapter 06: The Fair Voting Booth (The Softmax Function)](06-softmax-function/index.html)
...
- [🎛️ Chapter 07: The Attention Formula & Why We Divide by $\sqrt{d_k}$](07-attention-formula/index.html)
...
- [⚖️ Chapter 12: Keeping Everyone Calm (LayerNorm & RMSNorm)](12-layer-norm-and-rmsnorm/index.html)
...
- [🏔️ Chapter 15: Walking Down the Mountain (Gradients & Backpropagation)](15-gradients-and-backpropagation/index.html)
...
- [🎖️ Chapter 18: Teaching Good Manners (RLHF, Reward Modeling, and DPO)](18-rlhf-and-dpo/index.html)
...
## 🛠️ How This Course is Engineered
