...
## 步骤 1：3 岁孩子也能懂的直觉（冷冻冰块、弹跳气体与俱乐部动态保安）

> [!INTUITION] 旋转温度计旋钮与贵宾室保安
...
> [!BRIDGING] 为什么大语言模型不能直接永远挑选概率第 1 名的词？
...
## 步骤 4：历史源流与思考演进（玻尔兹曼、Fan 与 Holtzman）
...
## 步骤 5：手把手超简单数字积木（4 词词表多温度计算与核采样手算）
