...
<h2 id="step-1">Step 1: 3岁小孩的直觉（巨型操场地图）</h2>

> [!INTUITION] 3岁小孩的直觉：巨型操场地图
...
<h2 id="step-2">Step 2: 承上启下的问题（从文字到数字）</h2>
...
<h2 id="step-5">Step 5: 具象微型算例（纸笔手算验证）</h2>

> [!EXAMPLE] 具象微型算例：2维宠物与载具操场
...
<nav aria-label="Chapter Navigation">
  <p>
    <a href="../00-next-word-prediction/index.html">&larr; 第00章：猜词游戏（自回归下一个词预测）</a> &nbsp;|&nbsp; 
    <a href="../index.html">课程总览 / 目录</a> &nbsp;|&nbsp; 
    <strong>下一章：</strong> <a href="../02-dot-product-and-similarity/index.html">第02章：衡量关联（点积与余弦相似度） &rarr;</a>
  </p>
</nav>
